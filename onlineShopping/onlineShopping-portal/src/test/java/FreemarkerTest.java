...
//        第四步：告诉config对象模板文件存放的路径。
        configuration.setDirectoryForTemplateLoading(new File("C:\\Users\\iu\\Desktop\\taotaostore\\maven\\onlineShopping\\onlineShopping-portal\\src\\main\\webapp\\WEB-INF\\ftl"));
        ...
        root.put("iu","iuiuiuiu");

        //        第八步：创建一个Writer对象，指定生成的文件保存的路径及文件名。
        Writer out = new FileWriter("C:\\Users\\iu\\Desktop\\taotaostore\\maven\\freemarker\\test.html");
